...
<?php __("You were logged in, so please %sgo back%s to retry the payment.", "paid-member-subscriptions"); ?>
...
<?php __("Your <strong>PayPal API credentials</strong> are missing. In order for the plugin to be able to cancel Recurring Profile setup with PayPal, please enter your API credentials %1$s here %2$s.", "paid-member-subscriptions"); ?>
